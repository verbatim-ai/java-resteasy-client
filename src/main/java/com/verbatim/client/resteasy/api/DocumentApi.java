...
public class DocumentApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public AckResponse delete2(@javax.annotation.Nonnull UUID id) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public Document get2(@javax.annotation.Nonnull UUID id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling get2");
    }
  ...
  /**
   * Update a document
   * Patch the editable attributes of a document — &#x60;filename&#x60;, &#x60;docCreate&#x60;, &#x60;docUpdate&#x60;, &#x60;metadata&#x60;, &#x60;tags&#x60; and &#x60;chunk&#x60;. Only the fields present in the request body are updated; omitted fields keep their current value.  &#x60;metadata&#x60;, &#x60;tags&#x60; and &#x60;chunk&#x60; **replace** the stored value when provided — merge client-side if you want to preserve existing entries. Send &#x60;\&quot;tags\&quot;: []&#x60; to clear every tag, and &#x60;\&quot;chunk\&quot;: {}&#x60; to drop the chunking override and fall back to the platform default.  &#x60;docCreate&#x60; and &#x60;docUpdate&#x60; describe the **source** document, not the platform row: they are yours to correct, while &#x60;createdAt&#x60; and &#x60;updatedAt&#x60; remain server-managed and cannot be set here. Both are always set — a document uploaded without them carries the upload instant rather than a null — so this is the endpoint that replaces a guessed date with a real one. Neither can be cleared: omitting a field means *leave it alone*, and there is no value that means *unset*.  Every attribute is descriptive: renaming a document does not move the stored file nor re-trigger ingestion, so embeddings and previews are left untouched. Changing &#x60;chunk&#x60; likewise applies to the **next** ingestion — it does not re-chunk an already ingested document. Available in any lifecycle status. 
   * @param id ID of the document to update. (required)
   * @param documentUpdateRequest  (required)
   * @return a {@code Document}
   * @throws ApiException if fails to make API call
   */
  public Document update2(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull DocumentUpdateRequest documentUpdateRequest) throws ApiException {
    ...
    if (documentUpdateRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'documentUpdateRequest' when calling update2");
    }
