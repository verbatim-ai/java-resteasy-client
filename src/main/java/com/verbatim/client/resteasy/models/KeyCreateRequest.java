 ...
 */
@JsonPropertyOrder({
  KeyCreateRequest.JSON_PROPERTY_NAME,
  KeyCreateRequest.JSON_PROPERTY_DESCRIPTION
})
...
public class KeyCreateRequest {
  ...
  public KeyCreateRequest name(@javax.annotation.Nonnull String name) {
  ...
  public KeyCreateRequest description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, keyCreateRequest.name) &&
        Objects.equals(this.description, keyCreateRequest.description);
  }
