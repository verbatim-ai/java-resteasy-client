...
@JsonPropertyOrder({
  ...
  Thread.JSON_PROPERTY_USER_ID,
  Thread.JSON_PROPERTY_CORPUS_IDS,
  Thread.JSON_PROPERTY_METADATA,
  Thread.JSON_PROPERTY_CREATED_AT,
  Thread.JSON_PROPERTY_UPDATED_AT,
  Thread.JSON_PROPERTY_MODEL
})
...
public class Thread {
  ...
  public Thread id(@javax.annotation.Nonnull UUID id) {
  ...
  public Thread userId(@javax.annotation.Nullable String userId) {
  ...
  public Thread corpusIds(@javax.annotation.Nonnull List<UUID> corpusIds) {
    
    this.corpusIds = corpusIds;
    return this;
  }

  public Thread addCorpusIdsItem(UUID corpusIdsItem) {
  ...
  public Thread metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public Thread putMetadataItem(String key, Object metadataItem) {
  ...
  public Thread createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public Thread updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  public Thread model(@javax.annotation.Nullable String model) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, thread.id) &&
        Objects.equals(this.userId, thread.userId) &&
        Objects.equals(this.corpusIds, thread.corpusIds) &&
        Objects.equals(this.metadata, thread.metadata) &&
        Objects.equals(this.createdAt, thread.createdAt) &&
        Objects.equals(this.updatedAt, thread.updatedAt) &&
        Objects.equals(this.model, thread.model);
  }
