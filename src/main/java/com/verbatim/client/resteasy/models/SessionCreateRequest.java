...
public class SessionCreateRequest {
  ...
  /**
   * IDs of the corpora the thread is bound to (UUIDv4). A thread may search across several corpora.
   * @return corpusIds
   */
  @javax.annotation.Nonnull
  ...
  /**
   * Arbitrary JSON metadata attached to the thread. Stored as JSONB.
   * @return metadata
   */
  @javax.annotation.Nullable
