 ...
 */
@JsonPropertyOrder({
  KeyUpdateRequest.JSON_PROPERTY_NAME,
  KeyUpdateRequest.JSON_PROPERTY_DESCRIPTION
})
...
public class KeyUpdateRequest {
  ...
  public KeyUpdateRequest name(@javax.annotation.Nullable String name) {
  ...
  /**
   * New name of the key. Omit to keep the current name.
   * @return name
   */
  @javax.annotation.Nullable
  ...
  public KeyUpdateRequest description(@javax.annotation.Nullable String description) {
  ...
  /**
   * New description of the key. Omit to keep the current description.
   * @return description
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    KeyUpdateRequest keyUpdateRequest = (KeyUpdateRequest) o;
    return Objects.equals(this.name, keyUpdateRequest.name) &&
        Objects.equals(this.description, keyUpdateRequest.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyUpdateRequest {\n");
