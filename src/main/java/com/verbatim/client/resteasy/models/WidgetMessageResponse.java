...
import com.verbatim.client.resteasy.models.WidgetMessageResponseItem;
 ...
 */
@JsonPropertyOrder({
  WidgetMessageResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WidgetMessageResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private WidgetMessageResponseItem data;

  public WidgetMessageResponse() {
  }

  public WidgetMessageResponse data(@javax.annotation.Nullable WidgetMessageResponseItem data) {
  ...
  public WidgetMessageResponseItem getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable WidgetMessageResponseItem data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    WidgetMessageResponse widgetMessageResponse = (WidgetMessageResponse) o;
    return Objects.equals(this.data, widgetMessageResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class WidgetMessageResponse {\n");
