 ...
 */
@JsonPropertyOrder({
  WidgetSessionRequestBody.JSON_PROPERTY_TEXT,
  WidgetSessionRequestBody.JSON_PROPERTY_SESSION_UUID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WidgetSessionRequestBody {
  ...
  public WidgetSessionRequestBody() {
  }

  public WidgetSessionRequestBody text(@javax.annotation.Nullable String text) {
  ...
  public WidgetSessionRequestBody sessionUuid(@javax.annotation.Nullable String sessionUuid) {
  ...
  public boolean equals(Object o) {
    ...
    WidgetSessionRequestBody widgetSessionRequestBody = (WidgetSessionRequestBody) o;
    return Objects.equals(this.text, widgetSessionRequestBody.text) &&
        Objects.equals(this.sessionUuid, widgetSessionRequestBody.sessionUuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(text, sessionUuid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WidgetSessionRequestBody {\n");
