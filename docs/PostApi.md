...
import com.verbatim.client.resteasy.api.PostApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            AckResponse result = apiInstance.delete6(postId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PostApi#delete6");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        UUID postId = UUID.fromString("123e4567-e89b-12d3-a456-426614174000"); // UUID | ID of the post.
        try {
            Post result = apiInstance.get6(postId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PostApi#get6");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| **order** | **String**| Direction to read the thread in: &#x60;DESC&#x60; newest first, &#x60;ASC&#x60; oldest first. Defaults to &#x60;DESC&#x60;. | [optional] [enum: ASC, DESC] |
...
> PostItemResponse query(threadId, body, sessionId, lang, agentId)
...
public class Example {
    public static void main(String[] args) {
        ...
        PostApi apiInstance = new PostApi(defaultClient);
        UUID threadId = UUID.fromString("123e4567-e89b-12d3-a456-426614174000"); // UUID | ID of the thread to post the query into.
        ...
        try {
            PostItemResponse result = apiInstance.query(threadId, body, sessionId, lang, agentId);
            System.out.println(result);
        } catch (ApiException e) {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **threadId** | **UUID**| ID of the thread to post the query into. | |
