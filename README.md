...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'resteasy' jar has been published to maven central.
    mavenLocal()       // Needed if the 'resteasy' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.verbatim.client:resteasy:1.0.0"
  }
```
...
import com.verbatim.client.resteasy.invoker.*;
import com.verbatim.client.resteasy.invoker.auth.*;
import com.verbatim.client.resteasy.models.*;
...
*ThreadApi* | [**callList**](docs/ThreadApi.md#callList) | **GET** /v1/session/ | List threads
